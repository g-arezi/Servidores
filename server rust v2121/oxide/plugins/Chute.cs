...
{
    [Info("Chute", "ColonBlow", "2.0.2", ResourceId = 2279)]
    class Chute : RustPlugin
    {
        // added chute.up.allowed perms for those commands
        // added chute.vipcooldown perms for cooldowns
        ...
        public bool ActiveChutePlayerList(BasePlayer player)
        {
        ...
        bool UnderCooldown(BasePlayer player)
        {
        ...
        private void OnEntityTakeDamage(BaseCombatEntity entity, HitInfo hitInfo)
        {
            ...
            if (entity is BasePlayer)
            {
                ...
                if (ActiveChutePlayerList(victim))
                {
